    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(0.0, 234.0, -2.0, 0.0),
            child: Stack(
              children: <Widget>[
                Container(
                ...
                Pinned.fromPins(
                  Pin(start: 37.0, end: 53.0),
                  Pin(size: 51.0, middle: 0.1841),
                  child: Text(
                    'Create Account',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromPins(
                  Pin(size: 69.0, start: 53.0),
                  Pin(size: 20.0, middle: 0.3477),
                  child: Text(
                    'Full Name',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromPins(
                  Pin(size: 67.0, start: 54.0),
                  Pin(size: 20.0, middle: 0.6344),
                  child: Text(
                    'Password',
                    style: TextStyle(
                      fontFamily: 'Poppins',
                ...
                Pinned.fromPins(
                  Pin(size: 127.0, start: 54.0),
                  Pin(size: 20.0, middle: 0.7778),
                  child: Text(
                    'Confirm Password',
                    style: TextStyle(
                      fontFamily: 'Poppins',
