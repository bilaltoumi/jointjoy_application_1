    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 74.0, middle: 0.3455),
            Pin(size: 19.0, start: 90.0),
            child: Text.rich(
              TextSpan(
                style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(size: 128.0, middle: 0.4211),
            Pin(size: 15.0, start: 108.0),
            child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 13.8, end: 32.2),
            Pin(size: 13.8, start: 102.0),
            child:
                // Adobe XD layer: 'Icon feather-search' (group)
                Stack(
              children: <Widget>[
                Padding(
                  padding: EdgeInsets.fromLTRB(0.0, 0.0, 1.5, 1.5),
          ...
          Align(
            alignment: Alignment(0.14, -0.206),
            child: Container(
              width: 117.0,
              height: 152.0,
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 117.0, end: -19.0),
            Pin(size: 152.0, middle: 0.397),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xfffe5863),
                borderRadius: BorderRadius.circular(10.0),
              ),
            ),
          ),
          ...
          Align(
            alignment: Alignment(0.068, -0.048),
            child: SizedBox(
              width: 66.0,
              height: 26.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 31.0, end: 35.0),
            Pin(size: 15.0, middle: 0.271),
            child: PageLink(
              links: [
                PageLinkInfo(
                  duration: 0.5, // 0.5 seconds (500 milliseconds)0.5, // 0.5 seconds (500 milliseconds),
          ...
          Align(
            alignment: Alignment(0.015, -0.274),
            child: SizedBox(
              width: 50.0,
              height: 57.0,
              child: Stack(
                  ...
                  Pinned.fromPins(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromPins(
                          Pin(size: 38.0, end: 4.0),
                          Pin(size: 6.0, middle: 0.4815),
                          child: Text(
                            'Crear Homepage',
                            style: TextStyle(
                              fontFamily: 'Euclid Circular A',
...
const String _svg_mw144d =
    '<svg viewBox="4.5 4.5 12.3 12.3" ><path  d="M 16.75624847412109 10.62812328338623 C 16.75624847412109 14.01259422302246 14.01259326934814 16.75624847412109 10.62812328338623 16.75624847412109 C 7.243654251098633 16.75624847412109 4.5 14.01259326934814 4.5 10.62812328338623 C 4.5 7.243654251098633 7.243655204772949 4.5 10.62812328338623 4.5 C 14.01259422302246 4.5 16.75624847412109 7.243655204772949 16.75624847412109 10.62812328338623 Z" fill="none" stroke="#92a5c6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_db22zw =
    '<svg viewBox="15.0 15.0 3.3 3.3" ><path transform="translate(-10.02, -10.02)" d="M 28.30716705322266 28.30716705322266 L 24.97500228881836 24.97500228881836" fill="none" stroke="#92a5c6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg>';
...
const String _svg_y83k27 =
    '<svg viewBox="9.2 9.7 21.6 10.8" ><path transform="translate(0.0, 0.0)" d="M 30.53405380249023 18.91071128845215 L 22.31451797485352 10.66757011413574 C 21.02388572692871 9.376800537109375 18.93120956420898 9.376800537109375 17.64057350158691 10.66756916046143 L 9.37382698059082 18.91071128845215 C 9.086064338684082 19.28817367553711 9.123229026794434 19.82058525085449 9.460640907287598 20.1544075012207 C 9.798051834106445 20.48822975158691 10.33083057403564 20.51969718933105 10.70519256591797 20.22791481018066 L 18.95305252075195 12.00365734100342 C 19.21881103515625 11.73697662353516 19.57980918884277 11.58707904815674 19.95630073547363 11.58707904815674 C 20.33279037475586 11.58707904815674 20.69378852844238 11.73697662353516 20.95954704284668 12.00365734100342 L 29.20268821716309 20.22791481018066 C 29.57163619995117 20.59686470031738 30.16982460021973 20.59686470031738 30.53877639770508 20.22791481018066 C 30.90772438049316 19.85896301269531 30.90772438049316 19.26077651977539 30.53877639770508 18.8918285369873 Z" fill="#367be2" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_atee07 =
    '<svg viewBox="17.0 496.0 117.0 152.0" ><path transform="translate(17.0, 496.0)" d="M 10 0 L 107 0 C 112.5228500366211 0 117 4.477152347564697 117 10 L 117 142 C 117 147.5228424072266 112.5228500366211 152 107 152 L 10 152 C 4.477152347564697 152 0 147.5228424072266 0 142 L 0 10 C 0 4.477152347564697 4.477152347564697 0 10 0 Z" fill="#58cbfe" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
