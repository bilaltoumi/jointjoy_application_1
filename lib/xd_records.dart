...
class XD_Records extends StatelessWidget {
  XD_Records({
    Key? key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Align(
            alignment: Alignment(-0.248, -0.579),
            child: Container(
              width: 117.0,
              height: 152.0,
          ...
          Pinned.fromPins(
            Pin(size: 22.1, middle: 0.167),
            Pin(size: 33.5, start: 123.2),
            child: SvgPicture.string(
              _svg_wn3x1e,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 117.0, end: 31.0),
            Pin(size: 152.0, middle: 0.2106),
            child: SvgPicture.string(
              _svg_u655yx,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Align(
            alignment: Alignment(-0.256, -0.058),
            child: Container(
              width: 117.0,
              height: 152.0,
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 117.0, end: 30.0),
            Pin(size: 152.0, middle: 0.4712),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xfff7bf12),
                borderRadius: BorderRadius.circular(10.0),
          ...
          Align(
            alignment: Alignment(-0.24, 0.464),
            child: Container(
              width: 117.0,
              height: 152.0,
              decoration: BoxDecoration(
...
const String _svg_wn3x1e =
    '<svg viewBox="58.9 123.2 22.1 33.5" ><path transform="matrix(0.0, -1.0, 1.0, 0.0, 55.0, 152.63)" d="M 9.796242713928223 5.623814582824707 C 10.88606071472168 3.356992244720459 14.11393737792969 3.356992244720459 15.20375633239746 5.623814582824707 L 29.3197021484375 20.71612548828125 C 30.27722549438477 22.70777320861816 22.4388599395752 26 20.22899055480957 26 L 4.771008968353271 26 C 2.561140537261963 26 -5.011341571807861 22.70777320861816 -4.053817749023438 20.71612548828125 L 9.796242713928223 5.623814582824707 Z" fill="#ffffff" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_u655yx =
    '<svg viewBox="227.0 139.0 117.0 152.0" ><path transform="translate(227.0, 139.0)" d="M 10 0 L 107 0 C 112.5228500366211 0 117 4.477152347564697 117 10 L 117 142 C 117 147.5228424072266 112.5228500366211 152 107 152 L 10 152 C 4.477152347564697 152 0 147.5228424072266 0 142 L 0 10 C 0 4.477152347564697 4.477152347564697 0 10 0 Z" fill="#fe5863" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_tsx41j =
    '<svg viewBox="228.0 483.0 117.0 152.0" ><path transform="translate(228.0, 483.0)" d="M 10 0 L 107 0 C 112.5228500366211 0 117 4.477152347564697 117 10 L 117 142 C 117 147.5228424072266 112.5228500366211 152 107 152 L 10 152 C 4.477152347564697 152 0 147.5228424072266 0 142 L 0 10 C 0 4.477152347564697 4.477152347564697 0 10 0 Z" fill="#fe5863" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
