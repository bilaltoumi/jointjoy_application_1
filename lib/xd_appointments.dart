...
class XD_Appointments extends StatelessWidget {
  XD_Appointments({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 58.0, middle: 0.3691),
            Pin(size: 12.0, start: 149.0),
            child: Text(
              'Rheumatology',
              style: TextStyle(
                fontFamily: 'Euclid Circular A',
          ...
          Align(
            alignment: Alignment(-0.293, -0.41),
            child: SizedBox(
              width: 44.0,
              height: 12.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.196, -0.192),
            child: SizedBox(
              width: 84.0,
              height: 12.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.207, -0.555),
            child: SizedBox(
              width: 80.0,
              height: 12.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.207, -0.337),
            child: SizedBox(
              width: 80.0,
              height: 12.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.207, -0.12),
            child: SizedBox(
              width: 80.0,
              height: 12.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 31.0, end: 42.0),
            Pin(size: 12.0, middle: 0.2225),
            child: Text(
              '2:00 am',
              style: TextStyle(
                fontFamily: 'Euclid Circular A',
          ...
          Pinned.fromPins(
            Pin(size: 31.0, end: 41.0),
            Pin(size: 12.0, middle: 0.3313),
            child: Text(
              '9:00 am',
              style: TextStyle(
                fontFamily: 'Euclid Circular A',
          ...
          Pinned.fromPins(
            Pin(size: 36.0, end: 50.0),
            Pin(size: 12.0, middle: 0.44),
            child: Text(
              '10:00 am',
              style: TextStyle(
                fontFamily: 'Euclid Circular A',
          ...
          Align(
            alignment: Alignment(-0.652, -0.486),
            child: SizedBox(
              width: 22.0,
              height: 34.0,
              child: SvgPicture.string(
          ...
          Pinned.fromPins(
            Pin(size: 95.0, end: 24.0),
            Pin(size: 79.0, middle: 0.4679),
            child: Stack(
              children: <Widget>[
                Container(
                  decoration: BoxDecoration(
                ...
                Pinned.fromPins(
                  Pin(size: 29.0, start: 10.0),
                  Pin(size: 10.0, middle: 0.2899),
                  child: Text(
                    'Duplicate',
                    style: TextStyle(
                      fontFamily: 'Euclid Circular A',
          ...
          Pinned.fromPins(
            Pin(size: 42.0, end: 34.0),
            Pin(size: 15.0, middle: 0.1857),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xff367be2),
                borderRadius: BorderRadius.circular(5.0),
          ...
          Pinned.fromPins(
            Pin(size: 12.0, end: 52.0),
            Pin(size: 8.0, start: 152.0),
            child: Text(
              'NHS',
              style: TextStyle(
                fontFamily: 'Euclid Circular A',
          ...
          Pinned.fromPins(
            Pin(size: 15.0, end: 52.0),
            Pin(size: 8.0, middle: 0.2935),
            child: Text(
              'Blood',
              style: TextStyle(
                fontFamily: 'Euclid Circular A',
...
const String _svg_xe8zgy =
    '<svg viewBox="61.4 200.1 22.1 33.5" ><path transform="matrix(0.0, -1.0, 1.0, 0.0, 57.5, 229.5)" d="M 9.796242713928223 5.623814582824707 C 10.88606071472168 3.356992244720459 14.11393737792969 3.356992244720459 15.20375633239746 5.623814582824707 L 29.3197021484375 20.71612548828125 C 30.27722549438477 22.70777320861816 22.4388599395752 26 20.22899055480957 26 L 4.771008968353271 26 C 2.561140537261963 26 -5.011341571807861 22.70777320861816 -4.053817749023438 20.71612548828125 L 9.796242713928223 5.623814582824707 Z" fill="#ffffff" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
